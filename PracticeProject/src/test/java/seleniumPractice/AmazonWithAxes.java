...
public class AmazonWithAxes {
	...
	void amazon() throws Exception {
		...
		List<WebElement> price = driver.findElements(By.xpath(
				"//span[@class='a-size-medium a-color-base a-text-normal']//ancestor::div[starts-with(@class,'a-section a-spacing-none puis-padding-right-small s-title-instructions-style')][1]//following-sibling::div[2]//descendant::span[@class='a-price-whole']"));

		// ancestor::div[starts-with(@class,'a-section a-spacing-none
		// puis-padding-right-small
		// s-title-instructions-style')][1]//following-sibling::div[2]//descendant::span[@class='a-price-whole']
